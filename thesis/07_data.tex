...
\begin{table}[htbp]
    ...
    \caption[Data excerpt of consumer 056's energy readings]{Data excerpt of consumer 056's energy readings.Energy consumption (\texttt{energy}) and energy production (\texttt{energyOut}) are measured in $10^{-10}$ kWh. \quantnet}
    \label{Tab:c056}
\end{table}
...
\begin{table}[htbp]
    ...
    {\csvcolii & \csvcoliii & \csvcoliv}%
    \caption[Data excerpt of prosumer 089's energy readings]{Data excerpt of consumer 089's energy readings. Energy consumption (\texttt{energy}) and energy production (\texttt{energyOut}) are measured in $10^{-10}$ kWh. \quantnet}
    \label{Tab:p089}
\end{table}
