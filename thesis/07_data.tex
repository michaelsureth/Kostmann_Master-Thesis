...
Visual inspection of the consumption time series of the prosumer data sets already made obvious, that the consumption data in most cases did not resemble the consumer households' consumption patterns at all. Generalized, four types of consumption patterns can be found in the data: 
