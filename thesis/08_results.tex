...
{\footnotesize
    ...
    table head=
    \hline\hline
     \multicolumn{1} {l}{\textbf{Scenario}} & \multicolumn{1} {|c}{\textbf{Oversupply}} & \multicolumn{1} {c}{\textbf{LEM price}} & \multicolumn{1} {c}{\textbf{Revenue (true values)}} & \multicolumn{1} {c}{\textbf{Revenue (predicted values)}} & \multicolumn{1} {c}{\textbf{Cost (true values)}} & \multicolumn{1} {c}{\textbf{Cost (predicted values)}} & \multicolumn{1} {c}{\textbf{Cost (no LEM)}} & \multicolumn{1} {c}{\textbf{Loss due to prediction errors}} & \multicolumn{1} {c}{\textbf{Savings due to LEM}}\\
    \hline,
    no head,
    separator=comma,
    respect all,
...
%& \csvcolvi & \csvcolvii & \csvcolviii & \csvcolxi & \csvcolx & \csvcolxi
