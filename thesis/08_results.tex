...
%& \multicolumn{1} {c}{\textbf{LEM price}} & \multicolumn{1} {c}{\textbf{Revenue (true values)}} & \multicolumn{1} {c}{\textbf{Revenue (predicted values)}} & \multicolumn{1} {c}{\textbf{Cost (true values)}} & \multicolumn{1} {c}{\textbf{Cost (predicted values)}} & \multicolumn{1} {c}{\textbf{Cost (no LEM)}} & \multicolumn{1} {c}{\textbf{Loss due to prediction errors}} & \multicolumn{1} {c}{\textbf{Savings due to LEM}}
