...
Table~\ref{Tab:simulationresults} contrasts the results of the market simulation in different supply scenarios in the case of true and predicted consumption values. The equilibrium and LEM prices almost do not differ in all three scenarios wether the true or predicted consumption values are used. Also, the average total revenue over the three month simulation period of the prosumers is largely unchanged. What differs, however, is the cost for consumers. 
%
\begingroup\catcode`"=9
\begin{table}[ht]
{\footnotesize
