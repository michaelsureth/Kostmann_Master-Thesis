...
\begin{figure}[H]
    ...
    \caption[Squared relative errors of predictions by LSTM model on consumer 027]{Squared relative errors of predictions by LSTM model on data set of consumer 027. \quantnet\href{ }{BLEMevaluateEnergyPreds}}
\end{figure}
\end{centering}
...
\begin{figure}[H]
    ...
    \caption[Energy production time series of relevant prosumer data sets]{Energy production time series of relevant prosumer data sets in the time period from 01.10.2017 00:00 to 01.01.2018 00:00. \quantnet\href{ }{BLEMmarketSimulation}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[Market outcomes simulated with predicted values in three supply scenarios]{Market outcomes per trading period simulated with predicted values in a balanced, an oversupply, and an undersupply scenario. \quantnet\href{}{BLEMmarketSimulation}}
\end{figure}
