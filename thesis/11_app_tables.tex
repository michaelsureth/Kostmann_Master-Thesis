...
\begin{table}[ht]
    \csvreader[centered tabular=cccccc,
    table head=
    \hline\hline
     \textbf{Min} & \textbf{Q1} & \textbf{Median} & \textbf{Mean} & \textbf{Q3} & \textbf{Max}\\
    \hline,
    ...
    {thesis/tables/summarystats_cons_totalcons.csv}{}%
...
\begin{table}[ht]
    ...
    late after line = ,
    table foot = \\\hline\hline]
    {thesis/tables/summarystats_prod_totalcons.csv}{}%
    {\csvcolii & \csvcoliii & \csvcoliv & \csvcolv & \csvcolvi & \csvcolvii}%
...
\begin{table}[ht]
    ...
    late after line = ,
    table foot = \\\hline\hline]
    {thesis/tables/summarystats_prod_totalprod.csv}{}%
    {\csvcolii & \csvcoliii & \csvcoliv & \csvcolv & \csvcolvi & \csvcolvii}%
