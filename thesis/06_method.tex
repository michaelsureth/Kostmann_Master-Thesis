...
\end{equation}
%
The internal structure of a LSTM cell is further clarified by Figure \ref{Fig:LSTMunit}.
%
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{thesis/figures/LSTMunit.pdf}
    \caption{Schematic representation of a LSTM unit. Adapted from \citet{Graves:2012}.}
    \label{Fig:LSTMunit}
\end{figure}
